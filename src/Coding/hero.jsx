...
const Hero = () => {
  return (
    <div
      id="Hero"
      className="h-auto w-full flex flex-col lg:flex-row items-center justify-center lg:space-x-10 space-y-10 lg:space-y-0 px-6 lg:px-24 xl:px-36 py-10 lg:py-20 bg-gradient-to-br from-black via-black to-purple-900">
      {/* Left Side */}
      <div className="flex-1 flex flex-col justify-center space-y-6" id="leftside">
        ...
        <div className="flex justify-center lg:justify-start">
          <button className="bg-blue-600 hover:bg-purple-900 transition-all duration-300 transform hover:scale-105 hover:shadow-xl text-white font-semibold text-lg py-4 px-10 rounded-lg flex items-center gap-3">
            Our Services
            <img
              src={Arrow}
              alt="arrow icon"
      ...
      <div className="flex-1 flex flex-col items-center space-y-6">
        <div className="flex justify-between w-full px-10">
          ...
          <img src={Circle} alt="circle graphic" className="max-w-[50px]" />        
        </div>
        <div className="flex justify-center">
          <img src={hero} alt="person graphic" className="w-64 lg:w-96 xl:w-[450px]" />
        </div>
        <div className="flex justify-between w-full px-10">
          <img src={star} alt="circle graphic" className="max-w-[75px]" />
        </div>
      </div>
    </div>
  );
